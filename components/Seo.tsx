...
export const metadata: Metadata = {
  metadataBase: new URL('https://www.keralatour.info'),
  ...
  alternates: {
    canonical: 'https://www.keralatour.info/',
  },
  openGraph: {
    ...
    url: 'https://www.keralatour.info/',
    siteName: 'Kerala Tour Information by BH Holidays',
    type: 'website',
    images: [
      {
        url: 'https://www.keralatour.info/img/KeralaTravelPackage.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://www.keralatour.info/img/KeralaTravelPackage.webp'],
  },
}
